...
api_router.include_router(category_routes, prefix="/categories", tags=["categories"])
api_router.include_router(order_routes, prefix="/orders", tags=["orders"])
api_router.include_router(viettelpost_routes, prefix="/viettelpost", tags=["viettel"])
